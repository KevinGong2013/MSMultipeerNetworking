...
@property (nonatomic, strong) MSThriftController *thriftController;
...
- (id)initWithServiceType:(NSString *)serviceType maxConcurrentRequests:(NSUInteger)maxConcurrentRequests
{
	...
	if (self) {
		...
		self.thriftController = [[MSThriftController alloc] initWithMultipeer:self];
